  ...
  <form>
    <div class="container">
      ...
      <div class="row mb-3">
        <div class="col-md-7">
          <router-link to="/">
            <h2>CALIBRATION ROOM - CAMERA<small><small>_ 0.2.0 version</small></small></h2>
          </router-link>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" :value="camera_only">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
...
const store_pose = async () => {
  await axios({
    ...
    data: {
      ...
      depth_y : camera_only,
      depth_z : camera_only,
      depth_roll : camera_only,
      depth_pitch : camera_only,
      depth_yaw : camera_only,
      lidar_x : camera_only,
      lidar_y : camera_only,
      lidar_z : camera_only,
      lidar_roll : camera_only,
      lidar_pitch : camera_only,
      lidar_yaw : camera_only,
